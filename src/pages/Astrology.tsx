  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Descubre tu destino con una lectura de tarot personalizada y gratuita."
        />
      </Helmet>
        ...
        <div className="relative w-full h-96">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center bg-black bg-opacity-50 text-center p-6">
            ...
            <p className="text-base md:text-lg text-white max-w-3xl">
              La astrología es una antigua práctica que busca comprender la
              influencia de los astros y los planetas en nuestras vidas. A
              diferencia del tarot, que utiliza símbolos y arquetipos para
              interpretar el presente y el futuro, la astrología se basa en la
              posición de los astros en un momento específico.
            </p>
          </div>
        </div>
