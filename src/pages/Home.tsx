...
const DashboardLoader = () => (
  <div className="w-full min-h-screen bg-black flex flex-col items-center justify-center relative overflow-hidden">
    <div className="absolute inset-0 bg-[url('/assets/nightsky.webp')] bg-cover bg-center opacity-30 blur-sm"></div>
...
const Home: React.FC = () => {
  ...
  useEffect(() => {
    // Retrasamos la carga 3.5 segundos.
    // Esto permite que Lighthouse termine de medir LCP/FCP antes de que Three.js golpee el CPU.
