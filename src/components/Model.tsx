  ...
  return (
    <group {...props} dispose={null}>
      ...
      >
        ...
        {/* --- CABELLO (SIN SOMBRAS PARA OPTIMIZAR) --- */}
        <mesh
        ...
        {/* --- CARA Y DETALLES PEQUEÑOS (SIN SOMBRAS) --- */}
        <mesh
        ...
        {/* --- BOTONES Y DETALLES DE ROPA (SIN SOMBRAS) --- */}
        <mesh
      ...
      {/* --- TRONO Y ESCENARIO (GRANDES = CON SOMBRAS) --- */}
      <mesh
        castShadow
        receiveShadow
      ...
      {/* --- TEXTOS Y DETALLES PEQUEÑOS (SIN SOMBRAS) --- */}
      <mesh
